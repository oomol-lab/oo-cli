...
export const enMessages = {
    ...
    "connector.search.text.accessStatus": "Access status",
    "connector.search.text.accessStatus.available": "available",
    "connector.search.text.accessStatus.connectionRequired": "connection required",
...
export const zhMessages = {
    ...
    "arguments.url": "URL",
    "arguments.value": "配置值",
    "connector.search.text.accessStatus": "访问状态",
    "connector.search.text.accessStatus.available": "可用",
    "connector.search.text.accessStatus.connectionRequired": "需要连接",
