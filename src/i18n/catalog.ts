...
export const enMessages = {
    ...
    "arguments.variableKey": "Variable key",
    ...
    "commands.variables.delete.description": "Delete a variable for the current account. Idempotent: succeeds even if the key does not exist.",
    ...
    "errors.variables.invalidKey": "Invalid variable key: {value}. Keys must be 1-256 characters and must not contain '/' or control characters.",
    ...
    "errors.variables.notFound": "Variable not found: {key}",
    ...
    "variables.create.success": "Saved variable {key} (updated {updatedAt}).",
    "variables.delete.success": "Deleted variable {key}.",
} as const;
...
export const zhMessages = {
    ...
    "commands.variables.get.description": "读取当前账号指定 key 的变量值。",
    "commands.variables.create.summary": "创建或更新变量",
    "commands.variables.create.description": "为当前账号创建或替换指定 key 的变量（last-write-wins）。",
    "commands.variables.delete.summary": "删除变量",
    "commands.variables.delete.description": "删除当前账号指定 key 的变量。幂等：即使 key 不存在也成功。",
    "options.variablesFromFile": "从文件读取变量值（UTF-8）",
    "options.variablesStdin": "从标准输入读取变量值（UTF-8）",
    "errors.variables.invalidKey": "无效的变量 key：{value}。key 必须为 1-256 个字符，且不能包含 '/' 或控制字符。",
    ...
    "errors.variables.notFound": "变量不存在：{key}",
    ...
    "variables.create.success": "已保存变量 {key}（更新于 {updatedAt}）。",
    "variables.delete.success": "已删除变量 {key}。",
