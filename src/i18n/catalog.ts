...
export const enMessages = {
    ...
    "open.doNotShare": "Anyone who opens this URL is signed in to your account. Do not share it.",
    "open.expires": "The URL expires in {seconds} seconds.",
    "open.hint": "Open this URL in your browser to sign in to OOMOL:",
    ...
    "commands.open.summary": "Create a browser sign-in URL",
    "options.open.redirect":
...
export const zhMessages = {
    ...
    "open.doNotShare": "任何打开此 URL 的人都会登录你的账号，请勿分享。",
    "open.expires": "该 URL 将在 {seconds} 秒后失效。",
    "open.hint": "在浏览器中打开此 URL 即可登录 OOMOL：",
    ...
    "commands.open.description": "生成一个短期有效的 URL，在浏览器中打开后即以当前账号登录 OOMOL 网站。",
    "commands.open.summary": "生成浏览器登录 URL",
    "options.open.redirect":
    ...
    "errors.auth.switch.userNotFound":
        "没有匹配 {value} 的已保存账号。",
    "errors.open.invalidResponse": "session code 服务返回了不受支持的响应内容。",
    "errors.open.redirectInvalid":
        "不允许跳转到 {value}。请使用 {endpoint} 或其子域名下的 http(s) URL。",
    "errors.open.requestError": "session code 请求失败：{message}",
    "errors.open.requestFailed": "session code 请求返回了 HTTP {status}。",
    "errors.billing.insufficientCredit":
